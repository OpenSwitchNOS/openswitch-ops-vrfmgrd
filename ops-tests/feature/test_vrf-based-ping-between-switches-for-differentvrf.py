...
###############################################################################
# Name:      test_vrf-based-ping-between-switches-for-differentvrf.py
#
# Objective: Move the interface oneside to another VRF and check If the ping is
#            succeding. It should fail
#
...
SW1_INTF2_IPV4_ADDR = "10.0.0.1/24"
SW1_INTF3_IPV4_ADDR = "10.0.0.1/24"
SW1_INTF4_IPV4_ADDR = "10.0.0.1/24"
...
SW2_INTF2_IPV4_ADDR = "10.0.0.2/24"
SW2_INTF3_IPV4_ADDR = "10.0.0.2/24"
SW2_INTF4_IPV4_ADDR = "10.0.0.2/24"
...
def test_vrf_based_ping_for_links_in_diffvrf(topology, configuration, step):
    """
    Test case:
        Move the interface oneside to another VRF and check If the ping is
        succeding. It should fail
    """
...
# Validate Mapped ports in Switch 2 vrf's
    ...
    ping = sw1.libs.vtysh.ping('10.0.0.2', vrf=vrf_red, count=1)
...
# UnMapping ports from vrf in Switch 1
    ...
    sleep(2)
# VRF based ping for link which is already presented in this vrf
    ping = sw1.libs.vtysh.ping('10.0.0.2', vrf=vrf_red, count=1)
